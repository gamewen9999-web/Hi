...
const CLUBS_DATA = [
  ...
  // League One (2025/26)
  { id:'cardiff',     name:'Cardiff City',       league:'league_one',     rep:2, color:'#0070B5', budget:5,   wage:0.132, sqRating:65 },
  { id:'luton',       name:'Luton Town',         league:'league_one',     rep:2, color:'#F78F1E', budget:5,   wage:0.129, sqRating:65 },
  { id:'plymouth',    name:'Plymouth Argyle',    league:'league_one',     rep:2, color:'#007B5E', budget:4.5, wage:0.112, sqRating:64 },
  { id:'rotherham',   name:'Rotherham United',   league:'league_one',     rep:2, color:'#D6001C', budget:4,   wage:0.095, sqRating:63 },
  { id:'blackpool',   name:'Blackpool',          league:'league_one',     rep:2, color:'#F58220', budget:4,   wage:0.1, sqRating:63 },
  { id:'bolton',      name:'Bolton Wanderers',   league:'league_one',     rep:2, color:'#FFFFFF', budget:4,   wage:0.096, sqRating:63 },
  { id:'huddersfield',name:'Huddersfield Town',  league:'league_one',     rep:2, color:'#0073CF', budget:5,   wage:0.114, sqRating:64 },
  { id:'wigan',       name:'Wigan Athletic',     league:'league_one',     rep:2, color:'#1B458F', budget:4,   wage:0.092, sqRating:63 },
  { id:'bradford',    name:'Bradford City',      league:'league_one',     rep:2, color:'#8A1538', budget:3,   wage:0.071, sqRating:61 },
  { id:'reading',     name:'Reading',            league:'league_one',     rep:2, color:'#004494', budget:5,   wage:0.113, sqRating:64 },
  { id:'barnsley',    name:'Barnsley',           league:'league_one',     rep:2, color:'#EE3524', budget:4,   wage:0.08, sqRating:62 },
  { id:'peterborough',name:'Peterborough Utd',   league:'league_one',     rep:2, color:'#034694', budget:4,   wage:0.08, sqRating:62 },
  { id:'stockport',   name:'Stockport County',   league:'league_one',     rep:1, color:'#003F6B', budget:3,   wage:0.07, sqRating:61 },
  { id:'doncaster',   name:'Doncaster Rovers',   league:'league_one',     rep:1, color:'#DD0000', budget:3,   wage:0.071, sqRating:61 },
  { id:'exeter',      name:'Exeter City',        league:'league_one',     rep:1, color:'#EC2227', budget:3,   wage:0.07, sqRating:61 },
  { id:'lincoln',     name:'Lincoln City',       league:'league_one',     rep:1, color:'#D6001C', budget:3,   wage:0.084, sqRating:62 },
  { id:'leyton_orient',name:'Leyton Orient',     league:'league_one',     rep:1, color:'#D6001C', budget:3,   wage:0.081, sqRating:62 },
  { id:'wycombe',     name:'Wycombe Wanderers',  league:'league_one',     rep:1, color:'#0B1A4A', budget:3,   wage:0.082, sqRating:62 },
  { id:'burton',      name:'Burton Albion',      league:'league_one',     rep:1, color:'#F7C600', budget:3,   wage:0.06, sqRating:60 },
  { id:'stevenage',   name:'Stevenage',          league:'league_one',     rep:1, color:'#FF0000', budget:2,   wage:0.051, sqRating:59 },
  { id:'mansfield',   name:'Mansfield Town',     league:'league_one',     rep:1, color:'#FFD200', budget:3,   wage:0.071, sqRating:61 },
  { id:'northampton', name:'Northampton Town',   league:'league_one',     rep:1, color:'#7C2529', budget:2.5, wage:0.062, sqRating:60 },
  { id:'port_vale',   name:'Port Vale',          league:'league_one',     rep:1, color:'#FFFFFF', budget:2.5, wage:0.063, sqRating:60 },
  { id:'afc_wimbledon',name:'AFC Wimbledon',     league:'league_one',     rep:1, color:'#003DA5', budget:2.5, wage:0.06, sqRating:60 },
  // League Two (2025/26)
  { id:'notts_county',name:'Notts County',       league:'league_two',     rep:1, color:'#000000', budget:1.5, wage:0.035, sqRating:58 },
  { id:'grimsby',     name:'Grimsby Town',       league:'league_two',     rep:1, color:'#000000', budget:1.5, wage:0.036, sqRating:58 },
  { id:'swindon',     name:'Swindon Town',       league:'league_two',     rep:1, color:'#CC0000', budget:1.5, wage:0.031, sqRating:57 },
  { id:'mk_dons',     name:'MK Dons',            league:'league_two',     rep:1, color:'#D6001C', budget:1.5, wage:0.031, sqRating:57 },
  { id:'bristol_rovers',name:'Bristol Rovers',   league:'league_two',     rep:1, color:'#004A97', budget:1.8, wage:0.043, sqRating:59 },
  { id:'cambridge',   name:'Cambridge United',   league:'league_two',     rep:1, color:'#F5A623', budget:1.8, wage:0.041, sqRating:59 },
  { id:'shrewsbury',  name:'Shrewsbury Town',    league:'league_two',     rep:1, color:'#0C4899', budget:1.8, wage:0.042, sqRating:59 },
  { id:'tranmere',    name:'Tranmere Rovers',    league:'league_two',     rep:1, color:'#FFFFFF', budget:1,   wage:0.026, sqRating:56 },
  { id:'colchester',  name:'Colchester United',  league:'league_two',     rep:1, color:'#0000FF', budget:1.5, wage:0.032, sqRating:57 },
  { id:'walsall',     name:'Walsall',            league:'league_two',     rep:1, color:'#D6001C', budget:1.5, wage:0.031, sqRating:57 },
  { id:'oldham',      name:'Oldham Athletic',    league:'league_two',     rep:1, color:'#004A97', budget:1.3, wage:0.027, sqRating:56 },
  { id:'chesterfield',name:'Chesterfield',       league:'league_two',     rep:1, color:'#1D5BA4', budget:1.3, wage:0.027, sqRating:56 },
  { id:'gillingham',  name:'Gillingham',         league:'league_two',     rep:1, color:'#003DA5', budget:1.2, wage:0.027, sqRating:56 },
  { id:'cheltenham',  name:'Cheltenham Town',    league:'league_two',     rep:1, color:'#D6001C', budget:1.2, wage:0.027, sqRating:56 },
  { id:'harrogate',   name:'Harrogate Town',     league:'league_two',     rep:1, color:'#F8C300', budget:1,   wage:0.022, sqRating:55 },
  { id:'crawley',     name:'Crawley Town',       league:'league_two',     rep:1, color:'#CC0000', budget:1,   wage:0.022, sqRating:55 },
  { id:'salford',     name:'Salford City',       league:'league_two',     rep:1, color:'#D6001C', budget:1.5, wage:0.031, sqRating:57 },
  { id:'barnet',      name:'Barnet',             league:'league_two',     rep:1, color:'#F58220', budget:1.2, wage:0.026, sqRating:56 },
  { id:'newport',     name:'Newport County',     league:'league_two',     rep:1, color:'#F7A32F', budget:1,   wage:0.019, sqRating:54 },
  { id:'fleetwood',   name:'Fleetwood Town',     league:'league_two',     rep:1, color:'#D6001C', budget:1,   wage:0.022, sqRating:55 },
  { id:'accrington',  name:'Accrington Stanley', league:'league_two',     rep:1, color:'#D6001C', budget:1,   wage:0.023, sqRating:55 },
  { id:'crewe',       name:'Crewe Alexandra',    league:'league_two',     rep:1, color:'#D6001C', budget:1,   wage:0.023, sqRating:55 },
  { id:'bromley',     name:'Bromley',            league:'league_two',     rep:1, color:'#FFFFFF', budget:1,   wage:0.022, sqRating:55 },
  { id:'barrow',      name:'Barrow',             league:'league_two',     rep:1, color:'#003DA5', budget:1,   wage:0.019, sqRating:54 },
  // National League (2025/26) — level 5, avg sqRating ~50
  { id:'carlisle',    name:'Carlisle United',    league:'national_league', rep:1, color:'#003DA5', budget:0.6, wage:0.016, sqRating:53 },
  { id:'morecambe',   name:'Morecambe',          league:'national_league', rep:1, color:'#D6001C', budget:0.5, wage:0.015, sqRating:52 },
  { id:'york',        name:'York City',          league:'national_league', rep:1, color:'#D00027', budget:0.5, wage:0.017, sqRating:53 },
  { id:'forest_green',name:'Forest Green Rovers',league:'national_league', rep:1, color:'#0B6E4F', budget:0.5, wage:0.016, sqRating:52 },
  { id:'southend',    name:'Southend United',    league:'national_league', rep:1, color:'#003DA5', budget:0.5, wage:0.015, sqRating:52 },
  { id:'scunthorpe',  name:'Scunthorpe United',  league:'national_league', rep:1, color:'#D6001C', budget:0.4, wage:0.015, sqRating:51 },
  { id:'halifax',     name:'FC Halifax Town',    league:'national_league', rep:1, color:'#003DA5', budget:0.4, wage:0.014, sqRating:51 },
  { id:'altrincham',  name:'Altrincham',         league:'national_league', rep:1, color:'#FF0000', budget:0.3, wage:0.014, sqRating:51 },
  { id:'gateshead',   name:'Gateshead',          league:'national_league', rep:1, color:'#000000', budget:0.3, wage:0.014, sqRating:50 },
  { id:'hartlepool',  name:'Hartlepool United',  league:'national_league', rep:1, color:'#003DA5', budget:0.4, wage:0.015, sqRating:51 },
  { id:'rochdale',    name:'Rochdale',           league:'national_league', rep:1, color:'#003DA5', budget:0.4, wage:0.014, sqRating:51 },
  { id:'solihull',    name:'Solihull Moors',     league:'national_league', rep:1, color:'#F58220', budget:0.4, wage:0.015, sqRating:51 },
  { id:'yeovil',      name:'Yeovil Town',        league:'national_league', rep:1, color:'#0B6E4F', budget:0.4, wage:0.014, sqRating:51 },
  { id:'aldershot',   name:'Aldershot Town',     league:'national_league', rep:1, color:'#D6001C', budget:0.4, wage:0.015, sqRating:51 },
  { id:'eastleigh',   name:'Eastleigh',          league:'national_league', rep:1, color:'#003DA5', budget:0.3, wage:0.014, sqRating:50 },
  { id:'sutton',      name:'Sutton United',      league:'national_league', rep:1, color:'#FFB300', budget:0.3, wage:0.014, sqRating:50 },
  { id:'woking',      name:'Woking',             league:'national_league', rep:1, color:'#D6001C', budget:0.3, wage:0.014, sqRating:50 },
  { id:'boston_utd',  name:'Boston United',      league:'national_league', rep:1, color:'#D6001C', budget:0.3, wage:0.014, sqRating:50 },
  { id:'braintree',   name:'Braintree Town',     league:'national_league', rep:1, color:'#F58220', budget:0.3, wage:0.013, sqRating:49 },
  { id:'wealdstone',  name:'Wealdstone',         league:'national_league', rep:1, color:'#003DA5', budget:0.3, wage:0.014, sqRating:49 },
  { id:'tamworth',    name:'Tamworth',           league:'national_league', rep:1, color:'#D6001C', budget:0.3, wage:0.014, sqRating:49 },
  { id:'truro',       name:'Truro City',         league:'national_league', rep:1, color:'#FFFFFF', budget:0.3, wage:0.013, sqRating:49 },
  { id:'brackley',    name:'Brackley Town',      league:'national_league', rep:1, color:'#D6001C', budget:0.3, wage:0.013, sqRating:48 },
  { id:'boreham_wood',name:'Boreham Wood',       league:'national_league', rep:1, color:'#FFFFFF', budget:0.3, wage:0.013, sqRating:49 },
  // La Liga
